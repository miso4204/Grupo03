...
public class InitBean {
	...
	private static final Boolean RATE_PRODUCTS = Boolean.FALSE;
	
	private static final Boolean RATE_DESIGNS = Boolean.FALSE;
	...
	private static final String USER_BUILDER_STRATEGY = "NOT_EMAIL_NOT_PASSWORD";
	...
	/**payment variability**/
	private static final Boolean CASH_ON_DELIVERY = Boolean.FALSE;
	private Boolean cashOnDelivery;
	
	
	/**socialnetwork variability**/
	
	private static final Boolean TWITTER = Boolean.FALSE;
	private static final Boolean FACEBOOK = Boolean.FALSE;
